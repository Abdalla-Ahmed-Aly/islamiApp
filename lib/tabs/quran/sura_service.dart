...
class SuraService {
  ...
  static List<Sura> searshResult = List.generate(
    114,
  ...
  static void serchSuraName(String qurey) {
    searshResult.clear();
    for (int i = 0; i < englishSuraname.length; i++) {
      if (arabicSuraname[i].contains(qurey) ||
